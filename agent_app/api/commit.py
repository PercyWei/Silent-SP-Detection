...
def extract_commit_content_info(commit_content: str) -> Dict:
    """
    ...
    for i, section_start_line_idx in enumerate(changed_file_info_start_list):
        ...
        for j, hunk_start_line_idx in enumerate(changed_code_snippet_info_start_list):
            ...
            current_changed_code_snippet_info = {
                "old_file_line_start_idx": int(old_file_line_start_idx),  # (int)
                "old_file_line_scope": int(old_file_line_scope),          # (int)
                "new_file_line_start_idx": int(new_file_line_start_idx),  # (int)
                "new_file_line_scope": int(new_file_line_scope),          # (int)
                "changed_code_snippet": changed_code_snippet              # (str)
            }
...
def extract_useful_commit_content_info(commit_content: str) -> Dict:
    pass
